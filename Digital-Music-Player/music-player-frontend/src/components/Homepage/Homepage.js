        ...
        <div class="homepage-card">
            <div class="home-main-card">
                <div class="message-container">
                    ...
                    <span className="home-description">  Explore new musics, artists, genre, and more!</span>
                    <button className='home-listen-button' onClick={handleListenNowClick}>Listen Now</button>
                </div>
